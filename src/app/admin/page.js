        ...
        >
          {pendingTeachers.map((t) => (
            ...
            >
              ...
              >
                {t.board || "Board not selected"}
                {" • "}
                {t.field || "Field not selected"}
                {" • "}
                {t.subField || "Class not selected"}
              </div>
...
/* =========================================================
   ANIMATED SELECT
   IMPORTANT:
   Dropdown is rendered through a React Portal.
   This prevents parent cards / overflow / stacking
   contexts from hiding the dropdown.
========================================================= */
...
function AnimatedSelect({
  ...
  function getOptionColors(option) {
    ...
    if (color === "emerald") {
      return {
        className: "animated-option-emerald",
    ...
    if (color === "coral") {
      return {
        className: "animated-option-coral",
    ...
    return {
      className: "animated-option-gold",
  ...
  const dropdown =
    ...
    !disabled
      ? createPortal(
          <div
            data-animated-select-menu
            className="animated-select-portal"
            style={{
              top: menuPosition.top,
              left: menuPosition.left,
              width: menuPosition.width,
              maxHeight:
                "min(280px, calc(100vh - 16px))",
              borderRadius: 10,
              border:
              ...
              boxShadow:
                "0 18px 45px rgba(0,0,0,0.55), 0 0 25px rgba(255,182,39,0.14)",
              overflow: "hidden",
